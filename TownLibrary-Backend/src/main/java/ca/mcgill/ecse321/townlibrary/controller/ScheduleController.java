...
public class ScheduleController {
    ...
    public List<ScheduleDTO> getAllDailySchedules(){
    ...
    public List<ScheduleDTO> getLibrarianSchedules(@PathVariable("librarian") Librarian librarian){
        List<ScheduleDTO> dto = new ArrayList<ScheduleDTO>();
    ...
    @GetMapping(value={"/schedules/{librarian}", "/schedules/{librarian}/"})
    public ScheduleDTO getLibrarianSchedulePerDayOfWeek(@PathVariable("librarian") Librarian librarian, DayOfWeek dayOfWeek){
    ...
    @GetMapping(value={"/schedules", "/schedules/"})
    public List<ScheduleDTO> getDayOfWeekSchedule(@RequestParam DayOfWeek dayOfWeek){
        List<ScheduleDTO> dto = new ArrayList<ScheduleDTO>();
    ...
    public void assignSchedule(@RequestParam DailySchedule dailySchedule, @PathVariable Librarian librarian){
